---
title: "Transformation Track Overview"
sidebar_position: 1
description: "Structured roadmap for organizations adopting AI-assisted engineering."
---
...
Familiarity with the AEEF [Pillar 1: Engineering Discipline](/pillars/pillar-1-engineering-discipline/) and [Pillar 2: Security-First AI](/pillars/pillar-2-governance-risk/) is RECOMMENDED before beginning the transformation.
...
| **People** | Developer training cohort | Communities of practice | Enterprise prompt engineering |
| **Metrics** | Baseline measurement | Team and org KPI dashboards | Maturity certification |
| **Risk** | Pilot risk scoring | Automated risk assessment | Continuous risk management |
| **Key Milestone** | Pilot projects operational | Governance gates automated | Maturity certification awarded |
...
- **Organizational capability maturity** evidenced by formal [Maturity Certification](/transformation/phase-3-enterprise-scale/maturity-certification/)
...
Running in parallel with the three phases, the [Operating Model Lifecycle](/transformation/operating-model/) defines a six-stage process for every AI-assisted development initiative:
...
Engineering workflow transformation alone is not sufficient to become an AI company. Organizations shipping AI-powered product behavior MUST also implement controls for model quality and runtime behavior. The [AI Product Lifecycle](/transformation/ai-product-lifecycle/) provides those controls.
...
4. **Cross-reference pillars** — This track implements the standards defined in the AEEF [Pillars](/pillars/); refer to them for detailed technical requirements
